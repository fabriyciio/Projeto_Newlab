...
<html lang="pt">
    ...
    <body>
        ...
        <div class="container" >
            <form action="Inserirmedico.jsp" method="POST">
                ...
                <div class="form-group col-lg-4">
                    ...
                    <input id="datnascimento" name="datanascimento" type="text" class="form-control " aria-describedby="datnascimentoHelpBlock">
                </div>
